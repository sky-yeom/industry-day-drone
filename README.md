...
Drone sources, supervised flight runners, and the Speech tool boundary are in [drone-control](drone-control/README.md). The integration work on feat/drone preserves the dashboard scenario and route selection owned by this application.
