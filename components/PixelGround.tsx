...
export default function PixelGround({ scrolling = false }: { scrolling?: boolean }) {
  ...
  return (
    <div
      ...
      className="pixel-scene-ground pixel-scene-ground--scrolling pixel-rendering pointer-events-none absolute inset-x-0 bottom-0"
    />
  );
}
